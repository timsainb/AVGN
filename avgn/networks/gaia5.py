...
class GAIA(tf.keras.Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.gen_optimizer = tf.keras.optimizers.Adam(self.get_lr_g, beta_1 = 0.5)
        self.disc_optimizer = tf.keras.optimizers.RMSprop(self.get_lr_d)
    ...
    def get_lr_g(self):
        return self.lr_base#*self.G_prop


    def get_lr_d(self):
        return self.lr_base*self.D_prop
    ...
    def compute_loss(self, x):
        ...
        self.D_prop = sigmoid(d_x_loss - d_xi_loss, mult=20)
        self.G_prop = sigmoid(d_xi_loss - d_x_loss, mult=20)
        
        return self.D_prop, d_xg_loss, d_xi_loss, d_x_loss, xg_loss
    ...
    def compute_gradients(self, x):
        ...
        disc_gradients = disc_tape.gradient(disc_loss, self.disc.trainable_variables)#*(tf.constant(1.0)-D_prop)
